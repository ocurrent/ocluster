    ...
    repos = 
    {
      ...
      rec {
        fetch = 
        {
          ...
          rev = "f3e988407b1eee15c7009bd3b7106c66b8e46d18";
          sha256 = "1zplix7zmi01q2p3yn56zj5wzxkn995zyjajdg3hs6j0518gx1jd";
        };
...
in
{
  ...
  selection = 
  {
    ...
    camlp4 = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1fcn1z6dkvin112mlg9cd1qbikwgcawvfrlzkbzxx7khr0kjif24";
        package = "packages/camlp4/camlp4.4.10+1";
      };
      pname = "camlp4";
      src = pkgs.fetchurl 
      {
        sha256 = "17pjxqw87ikh5g589h123raw346g2c1nhskkc8gf2kl31s0ii6wx";
        url = "https://github.com/camlp4/camlp4/archive/4.10+1.tar.gz";
      };
      version = "4.10-1";
    };
    capnp = 
    ...
    capnp-rpc = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:19jvvsncfgf8yglvf2qp7wqz924rch0w70acvqax8ki2nfjyk4sg";
        package = "packages/capnp-rpc/capnp-rpc.0.9.0";
      };
      pname = "capnp-rpc";
      src = pkgs.fetchurl 
      {
        sha256 = "0apy2jilr9kl6jlnnknnahkk1a9g3546ri7gl4x2mf48pj5qgf10";
        url = "https://github.com/mirage/capnp-rpc/releases/download/v0.9.0/capnp-rpc-v0.9.0.tbz";
      };
      version = "0.9.0";
    };
    capnp-rpc-lwt = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1h86mh3va5b8h520b37h8xvlvr0ssyszxgqh5zzspa8wdiqv1llj";
        package = "packages/capnp-rpc-lwt/capnp-rpc-lwt.0.9.0";
      };
      pname = "capnp-rpc-lwt";
      src = pkgs.fetchurl 
      {
    ...
    capnp-rpc-net = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:17ygsnhg47j2cin6q8m8b4107jxvgm9aprx1wkk15jpwqh1v62bd";
        package = "packages/capnp-rpc-net/capnp-rpc-net.0.9.0";
      };
      pname = "capnp-rpc-net";
      src = pkgs.fetchurl 
      {
    ...
    capnp-rpc-unix = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:01zms5h6f6wc6zvjp300a6kp7h2pl5ipyr8kld769di285x52a42";
        package = "packages/capnp-rpc-unix/capnp-rpc-unix.0.9.0";
      };
    ...
    conf-libev = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1k2kn75wdkpwq5yc5ilk4vfh8whax7nh5s3azvd0c6nqyir6qbkw";
        package = "packages/conf-libev/conf-libev.4-11";
      };
      pname = "conf-libev";
      src = null;
      version = "4-11";
    ...
    conf-sqlite3 = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1hys1yw0z2a663mj5rcwdxj2h8j4qrhqm9qcp5z2b2yd7ppyx1b5";
    ...
    dune-build-info = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:0y6r5b6cshr20plb523vm81chgmiqj18cbixzisvh6i524df4004";
        package = "packages/dune-build-info/dune-build-info.2.7.1";
      };
    ...
    extunix = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:0g77kcp03qvl0849bq6jvwhdpwi1gv4rmd0j4ldjsbfrpddzdf9v";
      ...
      src = pkgs.fetchurl 
      {
        ...
        url = "https://ygrek.org/p/release/ocaml-extunix/ocaml-extunix-0.1.6.tar.gz";
      };
      version = "0.1.6";
    };
    fiat-p256 = 
    ...
    obuilder = 
    {
      opamInputs = 
      {
        ...
        logs = selection.logs;
        lwt = selection.lwt;
        obuilder-spec = selection.obuilder-spec;
        ocaml = selection.ocaml;
        ppx_deriving = selection.ppx_deriving;
        ppx_sexp_conv = selection.ppx_sexp_conv;
        sexplib = selection.sexplib;
        sha = selection.sha;
        sqlite3 = selection.sqlite3;
        tar-unix = selection.tar-unix;
        yojson = selection.yojson;
      };
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1cff7m3jdcdj8kgzfz1qvm01cihij7hhia5waxmb3j9xwgw5wq8l";
        package = "packages/obuilder/obuilder.0.2";
      };
      pname = "obuilder";
      src = pkgs.fetchurl 
      {
        sha256 = "0pfwdq34hx60lb0c4vm2j42czvqigkw0aiv72akjr12r21dpm2jr";
        url = "https://github.com/ocurrent/obuilder/releases/download/v0.2/obuilder-spec-v0.2.tbz";
      };
      version = "0.2";
    };
    obuilder-spec = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1b3hcfdb15jbg59knsjsdh3dawd9p7h8k1vcjm48mbpigd58fxrb";
        package = "packages/obuilder-spec/obuilder-spec.0.2";
      };
      pname = "obuilder-spec";
      src = pkgs.fetchurl 
      {
    ...
    ocaml-base-compiler = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:0g6s16d13x90ivx9pbn204ylx0vqh3nbs2xaakssqgj822wawapp";
    ...
    ocluster = 
    {
      ...
      opamSrc = "ocluster.opam";
      pname = "ocluster";
      src = self.directSrc "ocluster";
      version = "development";
    };
    ocluster-api = 
    {
      ...
      opamSrc = "ocluster-api.opam";
      pname = "ocluster-api";
      src = self.directSrc "ocluster-api";
      version = "development";
    };
    ocplib-endian = 
    {
    ...
    ppx_tools = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:17nlrrxwv1p8lsg2lna59xh0c6fg8i633mxyxfzf91xi8r0vhdh0";
        package = "packages/ppx_tools/ppx_tools.6.3";
      };
      pname = "ppx_tools";
      src = pkgs.fetchurl 
      {
        sha256 = "0n0zca54cvv8949qqbpil4y2wcgpv1m7bcffldpn0j6szzvpzwzn";
    ...
    prometheus = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1018ijhdavgmji6s50gsj4245410v5jncv7ibinsj40zgxh548j5";
        package = "packages/prometheus/prometheus.1.0";
      };
      pname = "prometheus";
      src = pkgs.fetchurl 
      {
        sha256 = "09mck80j3gn95k2m7am4kjya3nzhq73d1ba19a6iiyhn2l8yqz6i";
        url = "https://github.com/mirage/prometheus/releases/download/v1.0/prometheus-v1.0.tbz";
      };
      version = "1.0";
    };
    prometheus-app = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:14vgvd53ribsl80qippb037laqw6qvd4v7n8jvjwpj6sdagi113s";
        package = "packages/prometheus-app/prometheus-app.1.0";
      };
    ...
    sha = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:04zqjj6ihklj7llwy9614326lk4dljx8w133p8fqr88f0yvqfn8v";
        package = "packages/sha/sha.1.13";
      };
      pname = "sha";
      src = pkgs.fetchurl 
      {
    ...
    tar = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:0dpyf5sxysb7zgkv6jaqigxd1vkaihdvr61ywq94363104iby1gr";
        package = "packages/tar/tar.1.1.0";
      };
      pname = "tar";
      src = pkgs.fetchurl 
      {
    ...
    tar-unix = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1s3xyw28kai9f7iyhcl51dax9frwigxfnvrjyrzrhkvykyh6anf2";
        package = "packages/tar-unix/tar-unix.1.1.0";
      };
      pname = "tar-unix";
      src = pkgs.fetchurl 
      {
    ...
    tls-mirage = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:193wxa8fa7k3k88xqxlqgk6rb04ha5lpfr0zmqjxwk80qk2f880s";
        package = "packages/tls-mirage/tls-mirage.0.12.8";
      };
      pname = "tls-mirage";
      src = pkgs.fetchurl 
      {
